...
export function TextEditor({ value, onChange, placeholder, className }: TextEditorProps) {
  ...
  return (
    <div className="relative flex border rounded-md bg-background/50 overflow-hidden">
      ...
      <div 
        ref={lineNumbersRef}
        className="text-right text-sm text-muted-foreground bg-muted/20 border-r select-none overflow-hidden"
        style={{
          minWidth: '3.5rem',
      ...
      <Textarea
        ...
        className={`${className || "min-h-[400px] font-mono"} flex-1 border-0 bg-transparent focus:ring-2 focus:ring-primary/20 resize-none rounded-none overflow-x-auto`}
        style={{
          paddingTop: `${padding}px`,
          paddingBottom: `${padding}px`,
          paddingLeft: '12px',
